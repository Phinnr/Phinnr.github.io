...
export default defineConfig({
  title: "Kazora",
  description: "An unofficial repository of extensions for Kazora and variants.",
  cleanUrls: true,
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: 'github',
        link: 'https://github.com/Phinnr/extensions',
    ...
    editLink: {
      pattern: 'https://github.com/Phinnr/Phinnr.github.io/edit/main/website/:path',
